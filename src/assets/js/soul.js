; (function (d, w) {
  function soul () {
    var arr = [
      ...
      "如果你对目前的工作不太满意，觉得事业发展到了一个瓶颈，那么就去进修一个更高的学历吧，这样的话，毕业以后你就会明白，之前的失败跟学历似乎没什么关系。",
      ...
      "你就是个废物 一点用都没有",
      "如果上天没有给你想要的，不是你值得拥有更好的，而是你不配。别以为今天是你人生的低谷，在你未来的日子里它都能算的上是巅峰了",
      ...
      "有些姑娘特别信奉“爱我就要接受最真实的我”。但是首先你要保证“最真实的你”值得一爱啊。要腿没腿、要胸没胸、没文化还不读书、长得丑还不化妆。你还舔着大脸说帅哥都去搅基了、好男人都有主儿了，你自己说你不是缺心眼是什么。",
      ...
      "你长脑袋是为了看起来更高吗？",
      "每当我在学校值日的时候，老师会说学校是你家，维护靠大家！而当我迟到的时候，老师会说你以为学校是你家啊，想迟到就迟到？",
      ...
      "经过十年的不断奋斗和磨砺，我终于从一个懵懂无知敏感脆弱的少年，成长为了一个懵懂无知敏感脆弱的青年。",
      ...
      "先生？要喝汤吗？这汤喝了能忘掉所有的烦恼，五十一碗，无效退钱。嗯？您说好像见过我？哈哈，您可真会开玩笑。来，喝吧，包你喝完忘掉所有烦恼。这是什么汤？孟婆汤啊。先生，先生？要喝汤吗？",
      "你并不是一无所有，你还有病。",
      "其实表白未必是件好事，因为那样显得手黑。",
      ...
      "这个世界上90%的事能用钱解决，另外10%的事则需要更多的钱解决。",
      ...
      "只有精疲力竭，才知道放弃存在的意义",
      "现在流的泪，都是当初脑子进的水。",
      "这世上99%的事都可以用钱来解决，唯一不能解决的那1%就是没有钱。",
      ...
      "当你怀疑人生的时候，其实这就是你的人生。",
      "异性只为繁殖后代，同性才是真爱",
      "做一个小哥哥的备胎，你就是备胎，做100个小哥哥的备胎，小哥哥就是备胎——这就是量变引起质变！",
      "你是最棒的！不，是最胖的！",
  ...
  d.addEventListener('DOMContentLoaded', function () {
    d.querySelectorAll('.soul').forEach(function (el) {
      el.innerHTML = soul();
    })
  }, false)
})(document, window);
